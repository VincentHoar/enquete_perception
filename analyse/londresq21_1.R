#Q21. How concerned, if at all, are you about each of the following? - Poor air quality in Paris/votre commune
...
#Création de la table de contingence : EPT & Q21_1
Q21_1 = table(ipsoslondres$BOROUGH, ipsoslondres$GRID_Q21_1)
#Transformation de la table en dataframe
Q21_1 = as.data.frame.matrix(Q21_1)
Q21_1$id <- row.names(Q21_1)
Q21_1$total <- Q21_1$`1` + Q21_1$`2` + Q21_1$`3` + Q21_1$`4` +Q21_1$`5`
Q21_1$p1 <- Q21_1$`1` / Q21_1$total * 100
Q21_1$p2 <- Q21_1$`2` / Q21_1$total * 100
Q21_1$p3 <- Q21_1$`3` / Q21_1$total * 100
Q21_1$p4 <- Q21_1$`4` / Q21_1$total * 100
Q21_1$p5 <- Q21_1$`5` / Q21_1$total * 100
Q21_1$concerned <- Q21_1$p1 + Q21_1$p2
Q21_1$notconcerned <- Q21_1$p3 + Q21_1$p4
Q21_1$res <- Q21_1$concerned - Q21_1$notconcerned
res_borough <- merge(fondlondres, Q21_1, by.x = "BOROUGH", by.y = "id", all.x =TRUE)



# repartition
boxplot(Q21_1$p1, Q21_1$p2, Q21_1$p3, Q21_1$p4, Q21_1$p5, Q21_1$p6)
...
mf_layout(
  title = "Concerné ou non par l'environnement",
  credits = "IPSOS, Hoareau 2022",
  scale = 5, 2, 1.2
)  
