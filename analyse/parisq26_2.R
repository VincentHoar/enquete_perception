...
#- Immigration from elsewhere within France has had a positive impact on
...
Q26_2 = table(mergeparisipsos$ID_EPT, mergeparisipsos$GRID_Q26_2)
...
res_ept <- merge(ept, Q26_2, by.x = "ID_EPT", by.y = "id", all.x =TRUE)
...
mf_layout(
  title = "L'immigration venant d'autre part en France a un effet positif sur ma ville?",
  credits = "IPSOS, Hoareau 2022",
  scale = 4, 2, 1.2
)  
