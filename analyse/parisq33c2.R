...
Q33C_2 = table(mergeparisipsos$ID_EPT, mergeparisipsos$GRID_Q33C_2)
...
res_ept <- merge(ept, Q33C_2, by.x = "ID_EPT", by.y = "id", all.x =TRUE)
...
mf_layout(
  title = "Préoccupé par un outrage à la pudeur",
  credits = "IPSOS, Hoareau 2022",
  scale = 5, 2, 1.2
)
mf_map(res_ept, "notworried", type = "choro",pal = "Reds", leg_title = "En %",)
mf_layout(
  title = "Pas préoccupé par un outrage à la pudeur",
  credits = "IPSOS, Hoareau 2022",
  scale = 5, 2, 1.2
)  
# résumé 1 carte 
...
mf_layout(
  title = "Préoccupé ou non par un outrage à la pudeur",
  credits = "IPSOS, Hoareau 2022",
  scale = 4, 2, 1.2
)  
