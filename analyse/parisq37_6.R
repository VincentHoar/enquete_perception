#Q37. Thinking about Paris/Paris et sa région in the next few years after the coronavirus pandemic, do you think each of the following will get better, get worse, or stay the same? - Culture (theatres and museums)
...
Q37_6 = table(mergeparisipsos$ID_EPT, mergeparisipsos$GRID_Q37_NEW_6)
...
res_ept <- merge(ept, Q37_6, by.x = "ID_EPT", by.y = "id", all.x =TRUE)
