...
Q23_8 = table(ipsoslondres$BOROUGH, ipsoslondres$GRID_Q23_8)
...
res_borough <- merge(fondlondres, Q23_8, by.x = "BOROUGH", by.y = "id", all.x =TRUE)
...
mf_layout(
  title = "Réduire la vitesse de circulation dans les zones denses",
  credits = "IPSOS, Hoareau 2022",
  scale = 4, 2, 1.2
)  
