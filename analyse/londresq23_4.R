...
#- Funding more pavements, footpaths and pedestrian areas
...
#Création de la table de contingence : EPT & Q23_4
Q23_4 = table(ipsoslondres$BOROUGH, ipsoslondres$GRID_Q23_4)
#Transformation de la table en dataframe
Q23_4 = as.data.frame.matrix(Q23_4)
Q23_4$id <- row.names(Q23_4)
Q23_4$total <- Q23_4$`1` + Q23_4$`2` + Q23_4$`3` + Q23_4$`4` +Q23_4$`5` +Q23_4$`6`
Q23_4$p1 <- Q23_4$`1` / Q23_4$total * 100
Q23_4$p2 <- Q23_4$`2` / Q23_4$total * 100
Q23_4$p3 <- Q23_4$`3` / Q23_4$total * 100
Q23_4$p4 <- Q23_4$`4` / Q23_4$total * 100
Q23_4$p5 <- Q23_4$`5` / Q23_4$total * 100
Q23_4$p6 <- Q23_4$`6` / Q23_4$total * 100
Q23_4$daccord <- Q23_4$p1 + Q23_4$p2
Q23_4$pasdaccord <- Q23_4$p4 + Q23_4$p5
Q23_4$res <- Q23_4$daccord / Q23_4$pasdaccord
res_borough <- merge(fondlondres, Q23_4, by.x = "BOROUGH", by.y = "id", all.x =TRUE)



# repartition
boxplot(Q23_4$p1, Q23_4$p2, Q23_4$p3, Q23_4$p4, Q23_4$p5, Q23_4$p6)
...
mf_layout(
  title = "Support au financement de nouvelles zones piétonnes",
  credits = "IPSOS, Hoareau 2022",
  scale = 4, 2, 1.2
)  
