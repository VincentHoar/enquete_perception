#Q37. Thinking about Paris/Paris et sa région in the next few years after the coronavirus pandemic, do you think each of the following will get better, get worse, or stay the same? - Public transport
...
#Création de la table de contingence : EPT & Q37_1
Q37_1 = table(ipsoslondres$BOROUGH, ipsoslondres$GRID_Q37_NEW_1)
#Transformation de la table en dataframe
Q37_1 = as.data.frame.matrix(Q37_1)
Q37_1$id <- row.names(Q37_1)
Q37_1$total <- Q37_1$`1` + Q37_1$`2` + Q37_1$`3` + Q37_1$`4` +Q37_1$`5`
Q37_1$p1 <- Q37_1$`1` / Q37_1$total * 100
Q37_1$p2 <- Q37_1$`2` / Q37_1$total * 100
Q37_1$p3 <- Q37_1$`3` / Q37_1$total * 100
Q37_1$p4 <- Q37_1$`4` / Q37_1$total * 100
Q37_1$p5 <- Q37_1$`5` / Q37_1$total * 100


Q37_1$res <- Q37_1$p1 / Q37_1$p2
res_borough <- merge(fondlondres, Q37_1, by.x = "BOROUGH", by.y = "id", all.x =TRUE)



# repartition
boxplot(Q37_1$p1, Q37_1$p2, Q37_1$p3, Q37_1$p4, Q37_1$p5)
...
mf_layout(
  title = "Les transports vont s'améliorer après le COVID",
  credits = "IPSOS, Hoareau 2022",
  scale = 5, 2, 1.2
)
mf_map(res_borough, "p2", type = "choro",pal = "Reds", leg_title = "En %",)
mf_layout(
  title = "Les transports vont se détériorer",
  credits = "IPSOS, Hoareau 2022",
  scale = 5, 2, 1.2
)  
mf_map(res_borough, "p3", type = "choro",pal = "Blues", leg_title = "En %",)
mf_layout(
  title = "Les transports vont rester identiques",
  credits = "IPSOS, Hoareau 2022",
  scale = 5, 2, 1.2
)  