...
#It is too expensive for me to buy a property in Paris/Ma commune
...
Q11_1 = table(mergeparisipsos$ID_EPT, mergeparisipsos$GRID_Q11B_3)
...
# Résumé + - 
par(mfrow = c(1,2))
mf_map(res_ept, "daccord", type = "choro",pal = "Reds",  leg_title = "En %")
mf_layout(
  title = "L'accès à la propriété est trop cher pour moi",
  credits = "IPSOS, Hoareau 2022",
  scale = 5, 2, 1.2
)
mf_map(res_ept, "pasdaccord", type = "choro", leg_title = "En %",)
mf_layout(
  title = "L'accès à la propriété n'est pas trop cher pour moi",
  credits = "IPSOS, Hoareau 2022",
  scale = 5, 2, 1.2
)  
