#Q36. Thinking now about the future of Paris / Paris et sa région, how likely or unlikely would you say it is that each of the following will happen in the next five years? - Paris/Paris et sa région's economy will get weaker
...
Q36_1 = table(mergeparisipsos$ID_EPT, mergeparisipsos$GRID_Q36_1)
...
res_ept <- merge(ept, Q36_1, by.x = "ID_EPT", by.y = "id", all.x =TRUE)
