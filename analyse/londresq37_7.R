#Q37. Thinking about London in the next few years after the coronavirus pandemic, do you think each of the following will get better, get worse, or stay the same? - Public services (schools, hospitals, etc)
library(sf)
library(dplyr)
library(sp)
library(mapsf)
...
Q37_7 = table(ipsoslondres$BOROUGH, ipsoslondres$GRID_Q37_NEW_7)
...
res_borough <- merge(fondlondres, Q37_7, by.x = "BOROUGH", by.y = "id", all.x =TRUE)
