...
#- Paris/Ma commune is a good place to raise children
...
Q11_1 = table(mergeparisipsos$ID_EPT, mergeparisipsos$GRID_Q11B_1)
...
mf_layout(
  title = "Agréable pour faire grandir mes enfants",
  credits = "IPSOS, Hoareau 2022",
  scale = 5, 2, 1.2
)
mf_map(res_ept, "pasdaccord", type = "choro", pal = "Reds", leg_title = "En %",)
mf_layout(
  title = "Désagréable pour faire grandir mes enfants",
  credits = "IPSOS, Hoareau 2022",
  scale = 5, 2, 1.2
)  
# résumé 1 carte
...
mf_layout(
  title = "Ma commune est un bon endroit pour faire grandir mes enfants",
  credits = "IPSOS, Hoareau 2022",
  scale = 4, 2, 1.2
)  
