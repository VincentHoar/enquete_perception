...
Q23_1 = table(ipsoslondres$BOROUGH, ipsoslondres$GRID_Q23_1)
...
res_borough <- merge(fondlondres, Q23_1, by.x = "BOROUGH", by.y = "id", all.x =TRUE)
...
mf_layout(
  title = "Support d'un péage urbain en semaine dans le centre de Londres en semaine",
  credits = "IPSOS, Hoareau 2022",
  scale = 4, 2, 1.2
)  
