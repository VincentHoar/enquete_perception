...
#- Housing in Paris/Ma commune is affordable for people like me
...
Q11_1 = table(mergeparisipsos$ID_EPT, mergeparisipsos$GRID_Q11B_2)
...
mf_layout(
  title = "Abordable pour les gens comme moi",
  credits = "IPSOS, Hoareau 2022",
  scale = 5, 2, 1.2
)
mf_map(res_ept, "pasdaccord", type = "choro", pal = "Reds", leg_title = "En %",)
mf_layout(
  title = "Non-abordable pour les gens comme moi",
  credits = "IPSOS, Hoareau 2022",
  scale = 5, 2, 1.2
)  
# résumé 1 carte
...
mf_layout(
  title = "L'immobilier dans ma commune est abordable pour les gens comme moi",
  credits = "IPSOS, Hoareau 2022",
  scale = 4, 2, 1.2
)  
