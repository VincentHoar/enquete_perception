...
#-  Only allowing access to the centre of Paris to electric or hybrid cars or vans on some days
...
#Création de la table de contingence : EPT & Q23_6
Q23_6 = table(mergeparisipsos$ID_EPT, mergeparisipsos$GRID_Q23_6)
#Transformation de la table en dataframe
Q23_6 = as.data.frame.matrix(Q23_6)
Q23_6$id <- row.names(Q23_6)
Q23_6$total <- Q23_6$`1` + Q23_6$`2` + Q23_6$`3` + Q23_6$`4` +Q23_6$`5` +Q23_6$`6`
Q23_6$p1 <- Q23_6$`1` / Q23_6$total * 100
Q23_6$p2 <- Q23_6$`2` / Q23_6$total * 100
Q23_6$p3 <- Q23_6$`3` / Q23_6$total * 100
Q23_6$p4 <- Q23_6$`4` / Q23_6$total * 100
Q23_6$p5 <- Q23_6$`5` / Q23_6$total * 100
Q23_6$p6 <- Q23_6$`6` / Q23_6$total * 100
Q23_6$daccord <- Q23_6$p1 + Q23_6$p2
Q23_6$pasdaccord <- Q23_6$p4 + Q23_6$p5
Q23_6$res <- Q23_6$daccord / Q23_6$pasdaccord
res_ept <- merge(ept, Q23_6, by.x = "ID_EPT", by.y = "id", all.x =TRUE)



# repartition
boxplot(Q23_6$p1, Q23_6$p2, Q23_6$p3, Q23_6$p4, Q23_6$p5, Q23_6$p6)
...
mf_layout(
  title = "Autoriser l'accès au centre de Paris aux véhicules électriques ou hybrides uniquement certains jours",
  credits = "IPSOS, Hoareau 2022",
  scale = 4, 2, 1.2
)  
