...
Q23_7 = table(mergeparisipsos$ID_EPT, mergeparisipsos$GRID_Q23_7)
...
res_ept <- merge(ept, Q23_7, by.x = "ID_EPT", by.y = "id", all.x =TRUE)
...
mf_layout(
  title = "Réattribuer l'espace des véhicules aux cyclistes et piétons",
  credits = "IPSOS, Hoareau 2022",
  scale = 4, 2, 1.2
)  
