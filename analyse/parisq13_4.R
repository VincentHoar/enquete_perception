...
Q13_4 = table(mergeparisipsos$ID_EPT, mergeparisipsos$GRID_Q13_4)
...
res_ept <- merge(ept, Q13_4, by.x = "ID_EPT", by.y = "id", all.x =TRUE)
...
mf_layout(
  title = "Ma commune n'est pas un bon endroit pour les riches",
  credits = "IPSOS, Hoareau 2022",
  scale = 5, 2, 1.2
)  
# résumé 1 carte
