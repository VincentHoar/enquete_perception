...
Q13_2 = table(mergeparisipsos$ID_EPT, mergeparisipsos$GRID_Q13_2)
...
res_ept <- merge(ept, Q13_2, by.x = "ID_EPT", by.y = "id", all.x =TRUE)
...
mf_layout(
  title = "Ma commune n'est pas un bon endroit pour les vieux",
  credits = "IPSOS, Hoareau 2022",
  scale = 5, 2, 1.2
)  
# résumé 1 carte
...
mf_layout(
  title = "Ma commune est un bon endroit pour les personnes âgées",
  credits = "IPSOS, Hoareau 2022",
  scale = 4, 2, 1.2
)  
