...
Q13_5 = table(mergeparisipsos$ID_EPT, mergeparisipsos$GRID_Q13_5)
...
res_ept <- merge(ept, Q13_5, by.x = "ID_EPT", by.y = "id", all.x =TRUE)
...
mf_layout(
  title = "Ma commune n'est pas un bon endroit pour les pauvres",
  credits = "IPSOS, Hoareau 2022",
  scale = 5, 2, 1.2
)  
# résumé 1 carte
