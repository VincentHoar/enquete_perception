#Q37. Thinking about Paris/Paris et sa région in the next few years after the coronavirus pandemic, do you think each of the following will get better, get worse, or stay the same? - Hospitality (pubs, bars, restaurants and cafés)
...
Q37_5 = table(mergeparisipsos$ID_EPT, mergeparisipsos$GRID_Q37_NEW_5)
...
res_ept <- merge(ept, Q37_5, by.x = "ID_EPT", by.y = "id", all.x =TRUE)
...
mf_layout(
  title = "L'hospitalité dans la restauraiton va s'améliorer",
  credits = "IPSOS, Hoareau 2022",
  scale = 5, 2, 1.2
)
mf_map(res_ept, "p2", type = "choro",pal = "Reds", leg_title = "En %",)
mf_layout(
  title = "L'hospitalité dans la restauraiton va se détériorer",
  credits = "IPSOS, Hoareau 2022",
  scale = 5, 2, 1.2
)  
mf_map(res_ept, "p3", type = "choro",pal = "Blues", leg_title = "En %",)
mf_layout(
  title = "L'hospitalité dans la restauraiton va rester identique",
  credits = "IPSOS, Hoareau 2022",
  scale = 5, 2, 1.2
)  
