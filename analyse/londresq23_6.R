...
Q23_6 = table(ipsoslondres$BOROUGH, ipsoslondres$GRID_Q23_6)
...
res_borough <- merge(fondlondres, Q23_6, by.x = "BOROUGH", by.y = "id", all.x =TRUE)
...
mf_layout(
  title = "Autoriser le centre ville de Londres uniquement aux véhicules électriques et hybrides",
  credits = "IPSOS, Hoareau 2022",
  scale = 4, 2, 1.2
)  
